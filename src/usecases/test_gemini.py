...
class TestFindNextAvailableSlot(unittest.TestCase):
  ...
  def test_find_next_available_slot_success(self, mock_get_api_key, mock_get_tz, mock_genai_client_class):
      """
  ...
  @patch('src.usecases.gemini.get_local_timezone_offset')
  @patch('src.usecases.gemini.get_api_key')
  def test_find_next_available_slot_no_slots(self, mock_get_api_key, mock_get_tz, mock_genai_client_class):
      """
