...
class TestFormatEvents(unittest.TestCase):
  def test_format_events_with_events(self):
    ...
    expected = [
      "Event Name: Reunião de Alinhamento - starts at 2025-06-29T10:00:00-03:00 ends at 2025-06-29T11:00:00-03:00"
    ]
  ...
  def test_format_events_with_events_during_all_day(self):
    ...
    expected = [
      "Event Name: Feriado Nacional - starts at 2025-07-01 ends at 2025-07-02"
    ]
