...
def get_args():
  ...
  parser.add_argument('--id', required=False, default='primary', help='calendar id (default: "primary")')
  parser.add_argument('-w', '--waiting', required=False, default='30', help='waiting time to search events (default: 30)')
